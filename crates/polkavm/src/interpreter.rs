...
use crate::api::{InterpreterCacheInfo, MemoryAccessError, Module, RegValue};
...
pub(crate) struct InterpretedInstance {
    ...
    cycle_counter: u64,
    gas: i64,
    compiled_offset_for_block: FlatMap<NonZeroU32, true>,
...
impl InterpretedInstance {
    pub fn new_from_module(module: Module, force_step_tracing: bool) -> Self {
        ...
        debug_assert!(
            ...
            "Interpreter cache entry size mismatch"
        );
    ...
    pub fn set_interpreter_cache_size(&mut self, cache_info: Option<InterpreterCacheInfo>) {
        let Some(InterpreterCacheInfo {
            max_block_size,
        ...
        if compiled_handlers_hard_limit < minimum_compiled_handlers {
            log::trace!(
                "Interpreter cache size is too small to gurantee a tight upper bound: {} < {}",
